...
angular.module('starter.Directives').directive("fileread", [function () {
        return {
            scope: {
                fileread: "="
            },
...
// angular.module('starter.Directives').directive('filterBox', function() {
//     return {
//         // restrict: 'E',
//         // replace: true,
//         // scope: {
...
//         //     //             scope.getData({str: lnewValue}).then(function (results) {
//         //     //                 scope.model = results;
//         //     //             });
//         //     //         } else {
//         //     //             scope.model = [];
